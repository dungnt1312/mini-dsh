...
export function ErrorNotice({ raw, announce = true }: { readonly raw: string; readonly announce?: boolean }) {
  return (
    <div className="error-notice rounded-lg bg-bad-soft px-3 py-2 text-[13px] text-bad" role={announce ? 'alert' : undefined}>
